...
/opt/homebrew/Cellar/mame/0.287/bin/mame crusnusa -window -sound none -debug -log -skip_gameinfo -resolution 640x480 -debugscript tools/mame/output/mame_validate_breakpoints.txt
