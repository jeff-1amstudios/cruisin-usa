...
class DecompressSectionTests(unittest.TestCase):
    ...
    def test_sec_corn_matches_expected_length(self) -> None:
        ...
        output = decompress_section_raw_bytes(self.rom_bytes, descriptor.source_addr)
    ...
    def test_secgeneral_matches_mame_dump(self) -> None:
        output = decompress_section_bytes(self.rom_bytes, 0x00D160B4)
        expected = (DEFAULT_ROM.parent.parent / "mame_validate" / "00004B95-0.bin").read_bytes()
