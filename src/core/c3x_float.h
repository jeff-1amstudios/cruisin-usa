...
#define C3X_REG_FROM_DOUBLE(value) (c3x_from_double((double)(value)))
...
#define C3X_ADD_IMM(value, immediate) C3X_ADD((value), C3X_IMM_F32(immediate))
#define C3X_SUB_IMM(value, immediate) C3X_SUB((value), C3X_IMM_F32(immediate))
#define C3X_RSUB_IMM(immediate, value) C3X_SUB(C3X_IMM_F32(immediate), (value))
#define C3X_MUL_IMM(value, immediate) C3X_MUL((value), C3X_IMM_F32(immediate))
#define C3X_DIV_IMM(value, immediate) C3X_DIV((value), C3X_IMM_F32(immediate))
...
#define C3X_EQ_IMM(value, immediate) C3X_EQ((value), C3X_IMM_F32(immediate))
#define C3X_NE_IMM(value, immediate) C3X_NE((value), C3X_IMM_F32(immediate))
#define C3X_LT_IMM(value, immediate) C3X_LT((value), C3X_IMM_F32(immediate))
#define C3X_LE_IMM(value, immediate) C3X_LE((value), C3X_IMM_F32(immediate))
#define C3X_GT_IMM(value, immediate) C3X_GT((value), C3X_IMM_F32(immediate))
#define C3X_GE_IMM(value, immediate) C3X_GE((value), C3X_IMM_F32(immediate))
#define C3X_RND(a) (c3x_rnd(a))
#define C3X_FROM_RAW32(raw) (c3x_load(raw))
#define C3X_TO_RAW32(value) (c3x_store(value))
#define C3X_STF(value) (c3x_stf(value))
#define C3X_STF_IMM(immediate) C3X_STF(C3X_IMM_F32(immediate))
#define C3X_STF_INT(value) C3X_STF(C3X_FROM_INT(value))
