...
int COMPTRAK(void);
static void SEND_RACER_XSFER(PROC* p /*AR7*/);
void DECODE_RACER_XSFER(void);
static void ACTIVE_XSFER(void);
static int STEALTH_UPDATE(PROC* p /*AR7*/, OBJ* obj /*AR4*/, CARBLK* carblk /*AR5*/);
static void GETPOWER(PROC* p /*AR7*/, OBJ* obj /*AR4*/, CARBLK* carblk /*AR5*/);
static c3x_reg_t GETSTSPD(PROC* p /*AR7*/, CARBLK* carblk /*AR5*/);
OBJ* FIND_DYNA(int coded_id /*R2*/);
static LEG_PAYLOAD* FIND_MAP(PROC* p /*AR7*/, int coded_id /*R2*/);
...
static int CARCHEK(OBJ* obstacle_obj /*AR2*/, OBJ* obj /*AR4*/, CARBLK* carblk /*AR5*/, int table_code /*R0*/);
static c3x_reg_t GETPV(OBJ* obj /*AR2*/, CARBLK* carblk /*AR3*/, c3x_reg_t* angle_out /*R2*/);
static void GETWIDTH(OBJ* obj /*AR2*/, CARBLK* carblk /*AR3*/, c3x_reg_t* width_out /*R0*/, c3x_reg_t* height_out /*R1*/);
...
static RACER RACER_DRONE_INITTAB[] = {
    RDIM(VETTE_MOD, 4, C3X_F32_INIT(572.0f), C3X_F32_INIT(0.90f), C3X_F32_INIT(1.00f), (tPAL*)ROM_PTR(cvette_blue_ROM)),
    RDIM(HOTROD_MOD, 4, C3X_F32_INIT(1724.0f), C3X_F32_INIT(0.87f), C3X_F32_INIT(1.00f), (tPAL*)ROM_PTR(hotrod_yellow_ROM)),
    RDIM(TESTOR_MOD, 3, C3X_F32_INIT(572.0f), C3X_F32_INIT(0.84f), C3X_F32_INIT(1.00f), (tPAL*)ROM_PTR(testor_grape_ROM)),
    RDIM(BULLET_MOD, 3, C3X_F32_INIT(1724.0f), C3X_F32_INIT(0.81f), C3X_F32_INIT(1.00f), (tPAL*)ROM_PTR(missle_red_ROM)),
    RDIM(VETTE_MOD, 2, C3X_F32_INIT(572.0f), C3X_F32_INIT(0.78f), C3X_F32_INIT(1.00f), (tPAL*)ROM_PTR(cvette_purple_ROM)),
    RDIM(BULLET_MOD, 2, C3X_F32_INIT(1724.0f), C3X_F32_INIT(0.78f), C3X_F32_INIT(0.35f), (tPAL*)ROM_PTR(missle_blue_ROM)),
    RDIM(VETTE_MOD, 1, C3X_F32_INIT(1724.0f), C3X_F32_INIT(0.74f), C3X_F32_INIT(1.00f), (tPAL*)ROM_PTR(cvette_red_ROM)),
    RDIM(TESTOR_MOD, 1, C3X_F32_INIT(572.0f), C3X_F32_INIT(0.70f), C3X_F32_INIT(0.30f), (tPAL*)ROM_PTR(testor_blue_ROM)),
    RDIM(HOTROD_MOD, 0, C3X_F32_INIT(572.0f), C3X_F32_INIT(0.66f), C3X_F32_INIT(1.00f), (tPAL*)ROM_PTR(hotrod_brtblue_ROM)),
    RDIM(BULLET_MOD, 0, C3X_F32_INIT(1724.0f), C3X_F32_INIT(0.62f), C3X_F32_INIT(1.00f), (tPAL*)ROM_PTR(missle_yellow_ROM)),
};
 ...
 */
static c3x_reg_t GETDIFF(void) {
    c3x_reg_t difficulty;
    c3x_reg_t game_difficulty;
    int race_index;
    ...
    difficulty = C3X_ADD_IMM(C3X_MUL_IMM(C3X_FROM_INT(ADJUSTMENT_READ(ADJ_DIFFICULTY)), 0.04f), 0.80f); // GLOBAL DIFF 0.80-1.16
    ...
    if (HEAD2HEAD_ON != 0) {
        if (C3X_GT_IMM(game_difficulty, 1.16f)) {
            game_difficulty = C3X_IMM_F32(1.16f);
        }
        if (C3X_LT_IMM(game_difficulty, 0.8f)) {
            game_difficulty = C3X_IMM_F32(0.8f);
        }
        game_difficulty = C3X_MUL_IMM(C3X_ADD(game_difficulty, GAMEDIFF), 0.5f);
    }
GD1:
    ...
    game_difficulty = C3X_SUB(game_difficulty, C3X_FROM_INT(1));
    ...
    difficulty = C3X_ADD(difficulty, game_difficulty);
    difficulty = C3X_ADD(difficulty, C3X_LDF(DIFFTAB[race_index]));
    ...
    // asm 000050E0: 	RETS
    if (C3X_LT_IMM(difficulty, 0.75f)) {
        difficulty = C3X_IMM_F32(0.75f);
    }
    if (C3X_GT_IMM(difficulty, 1.25f)) {
        difficulty = C3X_IMM_F32(1.25f); // ABSOLUTE MAX/MINS
    }
    return difficulty;
}
...
void RACER_DRONE(PROC* p) {
    ...
    c3x_reg_t tracking_distance_sq;
    c3x_reg_t next_tracking_distance_sq;
    c3x_reg_t tracking_distance;
    c3x_reg_t speed;
    c3x_reg_t frames_to_piece;
    c3x_reg_t desired_theta;
    c3x_reg_t theta_delta;
    c3x_reg_t current_theta;
    c3x_reg_t frames_to_piece_divisor;
    c3x_reg_t steering_value;
    c3x_reg_t steering_delta_for_drone;
    c3x_reg_t turn_limit;
    c3x_reg_t initial_powercatch;
    c3x_reg_t delta_x;
    c3x_reg_t delta_z;
    c3x_reg_t lane_offset_x;
    ...
    p->ctx.RACER_DRONE.finishdist = C3X_STF_INT(0);
...
JJKK:
    ...
    vehicle = &VEHICLE_TABLE[init->model];
...
NOOTHERPAL:
    ...
    carblk->offroad_friction = C3X_STF(C3X_MUL_IMM(carblk->road_friction, 1.5f));
    ...
    difficulty = ((_MODE & MMODE) == MATTR) ? C3X_FROM_INT(1) : GETDIFF();
    // asm 0000512B: 	MPYF	*+AR0(RD_MAXACCEL),R0
    // asm 0000512C: 	STF	R0,*+AR5(CARMAXACCEL)	;SET ACCEL POWER
    carblk->max_accel = C3X_STF(C3X_MUL(C3X_LDF(init->maxaccel), difficulty));
    ...
    road_theta = SPOS_INIT(p, obj, tracking_obj, init->position);
    ...
    obj->id = DRONE_C | VEHICLE_T | DRNE_RACER;
    carblk->debug_car_id = DRONE_C | VEHICLE_T | DRNE_RACER;
    p->id = DRONE_C | VEHICLE_T | DRNE_RACER;
    ...
    if (HEAD2HEAD_ON != 0) {
        other_machine_controls = (DIPRAM & CMDP_MASTER) != 0 ? 0 : 1;
...
CKSTEALTH:
    ...
    if (C3X_LT(tracking_distance_sq, C3X_MUL(C3X_FROM_INT(5000), C3X_FROM_INT(5000)))) {
        goto NUTRACK;
    }
    ...
    delta_x = C3X_SUB(next_tracking_obj->pos.X, obj->pos.X);
    delta_z = C3X_SUB(next_tracking_obj->pos.Z, obj->pos.Z);
    next_tracking_distance_sq = C3X_ADD(C3X_MUL(delta_x, delta_x), C3X_MUL(delta_z, delta_z));
    // asm 0000518A: 	CMPF	R2,R1	       			;DIST TRACK CLOSER?
    // asm 0000518B: 	BGT	ONTRACK				;NO, WERE ON TRACK
    // asm 0000518C: 	NOP
    if (C3X_GT(next_tracking_distance_sq, tracking_distance_sq)) {
        goto ONTRACK;
    }
NUTRACK:
...
ONTRACK:
    ...
    tracking_distance = SQRT(tracking_distance_sq);
    ...
    frames_to_piece = DIV_F(tracking_distance, C3X_MUL(C3X_FROM_INT(NFRAMES), speed));
...
ROADTRAK1:
    ...
    desired_theta = C3X_SUB_IMM(ARCTANF(C3X_SUB(next_tracking_obj->pos.X, tracking_obj->pos.X), C3X_SUB(next_tracking_obj->pos.Z, tracking_obj->pos.Z)), HALFPI);
    ...
    desired_theta = C3X_SUB_IMM(ARCTANF(delta_x, delta_z), HALFPI);
    ...
    frames_to_piece_divisor = C3X_SUB(C3X_FROM_INT(FIX(frames_to_piece)), C3X_FROM_INT(1));
    if (C3X_NE(frames_to_piece_divisor, C3X_FROM_INT(0))) {
        theta_delta = DIV_F(theta_delta, frames_to_piece_divisor);
    }
NODIV:
    ...
    turn_limit = C3X_MUL_IMM(turn_limit, 0.416f);
    ...
    if (C3X_LT_IMM(steering_value, -0.3f)) {
        steering_value = C3X_IMM_F32(-0.3f);
    }
    // asm 000051D8: 	CMPF	0.3,R0 			;LIMIT CHECK
    // asm 000051D9: 	LDFGT	0.3,R0
    if (C3X_GT_IMM(steering_value, 0.3f)) {
        steering_value = C3X_IMM_F32(0.3f);
    }
NOTURN:
    // asm 000051DA: 	STF	R0,*+AR5(CARTURN)
    carblk->turn = C3X_STF(steering_value);
    ...
    carblk->turn = C3X_STF(C3X_NEG(carblk->turn));
RACER_SLP:
...
static void CKPCOL(OBJ* obj /*AR4*/, CARBLK* carblk /*AR5*/) {
    ...
    ahead_result = CKAHEAD(player_obj, player_carblk, obj, carblk);
    ...
    delta_x = C3X_SUB(player_obj->pos.X, obj->pos.X);
    // asm 0000521E: 	LDF	*+AR2(OPOSZ),R7
    // asm 0000521F: 	SUBF	*+AR4(OPOSZ),R7
    delta_z = C3X_SUB(player_obj->pos.Z, obj->pos.Z);
    // asm 00005220: 	MPYF	R6,R6,R1
    // asm 00005221: 	MPYF	R7,R7,R2
    // asm 00005222: 	ADDF	R1,R2			;distance^2
    distance_sq = C3X_ADD(C3X_MUL(delta_x, delta_x), C3X_MUL(delta_z, delta_z));
    // asm 00005223: 	FLOAT	3000,R0
    // asm 00005224: 	MPYF	R0,R0
    // asm 00005225: 	CMPF	R2,R0
    // asm 00005226: 	BLT	CARCHKX			;TOO FAR AWAY
    if (C3X_LT(C3X_MUL(C3X_FROM_INT(3000), C3X_FROM_INT(3000)), distance_sq)) {
        return;
    }
    // asm 00005227: 	LDF	*+AR5(CARSPEED),R0
    // asm 00005228: 	SUBF	*+AR3(CARSPEED),R0
    speed_difference = C3X_SUB(carblk->speed, player_carblk->speed);
    MAME_ASSERT_REG_FLOAT(0x00005229, "R0", &speed_difference);
    // asm 00005229: 	CMPF	30,R0
    // asm 0000522A: 	BLT	CKPX
    if (C3X_LT(speed_difference, C3X_FROM_INT(30))) {
        goto CKPX;
    }
    // asm 0000522B: 	NOP
CKPX:
...
STEALTH_UPDATE:
    ...
    delta_z = C3X_SUB(C3X_FROM_INT(map_entry->as_fixed.pos_z), C3X_LDF(obj->pos.Z));
    ...
    if (C3X_GT(distance_sq, C3X_MUL(C3X_FROM_INT(5000), C3X_FROM_INT(5000)))) {
        goto STLUP1;
    }
...
static void GETPOWER(PROC* p /*AR7*/, OBJ* obj /*AR4*/, CARBLK* carblk /*AR5*/) {
    ...
    c3x_reg_t delta_x;
    c3x_reg_t delta_z;
    c3x_reg_t player_distance;
    int player_track_id;
    int track_id;
    c3x_reg_t catch_power;
    c3x_reg_t first_place_boost;
    ...
    player_distance = C3X_ADD(C3X_MUL(delta_x, delta_x), C3X_MUL(delta_z, delta_z));
...
PDIST:
    ...
    track_id = (int)track_obj->usr1;
PDIST1:
    // asm 00005324: 	MPYF	0.01,R0
    // asm 00005325: 	MPYF	0.01,R0
    // asm 00005326: 	MPYF	0.07,R0
    player_distance = C3X_MUL_IMM(player_distance, 0.01f);
    player_distance = C3X_MUL_IMM(player_distance, 0.01f);
    player_distance = C3X_MUL_IMM(player_distance, 0.07f);
    // asm 00005327: 	CMPF	0.4,R0			;MAX OUT AT +-60%
    // asm 00005328: 	LDFGT	0.4,R0
    if (C3X_GT_IMM(player_distance, 0.4f)) {
        player_distance = C3X_IMM_F32(0.4f);
    }
    // asm 00005329: 	LDF	1.0,R3			;SIGN
    catch_power = C3X_FROM_INT(1); // ;SIGN
    // asm 0000532A: 	CMPI	R2,R1
    // asm 0000532B: 	LDFZ	0,R3			;EVEN RACE
    if (track_id == player_track_id) {
        catch_power = C3X_FROM_INT(0); // ;EVEN RACE
    }
    // asm 0000532C: 	LDFGT	-1.0,R3
    if (track_id > player_track_id) {
        catch_power = C3X_FROM_INT(-1);
    }
    ...
    if (C3X_LT_IMM(player_distance, 0.1f)) {
        player_distance = C3X_IMM_F32(0.1f); // ;MINIMUM IF AHEAD
    }
...
PDIST1A:
    ...
    if (C3X_LT_IMM(player_distance, 0.2f)) {
        player_distance = C3X_IMM_F32(0.2f); // ;MINIMUM IF BEHIND
    }
PDIST1B:
    // asm 00005333: 	MPYF	R3,R0,R3		;DO THE SIGN
    catch_power = C3X_MUL(catch_power, player_distance); // ;DO THE SIGN
    ...
    first_place_boost = C3X_MUL_IMM(C3X_MUL_IMM(C3X_FROM_INT(PLYRFIRST), 0.01f), 0.15f);
    // asm 00005338: 	CALL	FRAND
    first_place_boost = FRAND(first_place_boost);
    // asm 00005339: 	CMPF	0.15,R0
    // asm 0000533A: 	LDFGT	0.15,R0			;BOOST FOR LONG TIME FIRST
    if (C3X_GT_IMM(first_place_boost, 0.15f)) {
        first_place_boost = C3X_IMM_F32(0.15f); // ;BOOST FOR LONG TIME FIRST
    }
 ...
 */
static c3x_reg_t GETSTSPD(PROC* p /*AR7*/, CARBLK* carblk /*AR5*/) {
    c3x_reg_t acceleration;
    c3x_reg_t rpm_index_value;
    c3x_reg_t interpolation;
    c3x_reg_t power_low;
    c3x_reg_t power_high;
    c3x_reg_t power_factor;
    c3x_reg_t road_friction;
    c3x_reg_t engine_friction;
    c3x_reg_t engine_friction_scale;
    c3x_reg_t total_friction;
    c3x_reg_t speed;
    c3x_reg_t distance;
    c3x_reg_t friction;
    int table_index;
    ...
    carblk->throttle = C3X_STF(acceleration);
    // asm 00005355: 	MPYF	*+AR5(CARMAXACCEL),R0
    acceleration = C3X_MUL(C3X_LDF(carblk->max_accel), acceleration);
    // asm 00005356: 	LDF	*+AR5(CARRPM),R1
    // asm 00005357: 	MPYF	0.333,R1
    rpm_index_value = C3X_MUL_IMM(C3X_LDF(carblk->rpm_x100), 0.333f);
    // asm 00005358: 	FIX	R1,IR0		   	;GET TABLE INDEX
    table_index = FIX(rpm_index_value);
    ...
    power_low = C3X_LDF(ENGACTABI[table_index]);
    // asm 0000535D: 	ADDI	1,IR0
    table_index += 1;
    // asm 0000535E: 	LDF	*+AR0(IR0),R3		;GET HI POWER FACTOR FOR GEAR
    power_high = C3X_LDF(ENGACTABI[table_index]);
    // asm 0000535F: 	FLOAT	IR0,R4
    // asm 00005360: 	SUBF	R1,R4,R1
    interpolation = C3X_SUB(C3X_FROM_INT(table_index), rpm_index_value);
    // asm 00005361: 	LDFLT	0,R1  			;KEEP FACTOR IN BOUNDS
    if (C3X_LT(interpolation, C3X_FROM_INT(0))) {
        interpolation = C3X_IMM_F32(0);
    }
    // asm 00005362: 	CMPF	1.0,R1
    // asm 00005363: 	LDFGT	1.0,R1
    if (C3X_GT_IMM(interpolation, 1.0f)) {
        interpolation = C3X_IMM_F32(1.0f);
    }
    // asm 00005364: 	MPYF	R1,R2			;INTERPOLATE !!!
    power_low = C3X_MUL(interpolation, power_low);
    // asm 00005365: 	SUBRF	1.0,R1
    interpolation = C3X_RSUB_IMM(1.0f, interpolation);
    // asm 00005366: 	MPYF	R1,R3
    power_high = C3X_MUL(interpolation, power_high);
    // asm 00005367: 	ADDF	R2,R3,R1
    power_factor = C3X_ADD(power_low, power_high);
    // asm 00005368: 	LDI	*+AR5(CARGEAR),IR0	;GEAR MULTIPLIER
    gear = (int)carblk->gear;
    // asm 00005369: 	LDI	@GEARACTABI,AR0
    // asm 0000536A: 	MPYF	*+AR0(IR0),R1
    power_factor = C3X_MUL(C3X_LDF(GEARACTABI[gear]), power_factor);
    // asm 0000536B: 	MPYF	0.97,R1			;3% POWER LOSS AUTO
    power_factor = C3X_MUL_IMM(power_factor, 0.97f);
    // asm 0000536C: 	MPYF	R1,R0
    acceleration = C3X_MUL(power_factor, acceleration);
    // *GET TOTAL FRICTION
    // *GET ROAD FRICTION
    // asm 0000536D: 	LDF	*+AR5(CARRDFR),R3    	;GET ROAD FRICTION
    road_friction = C3X_LDF(carblk->road_friction);
    // *GET ENGINE FRICTION
    // asm 0000536E: 	LDI	*+AR5(CARGEAR),IR0
    gear = (int)carblk->gear;
    // asm 0000536F: 	LDI	@ENGFRI,AR0
    // asm 00005370: 	LDF	*+AR0(IR0),R4
    engine_friction = C3X_LDF(ENGFRI[gear]);
    // asm 00005371: 	LDF	*+AR5(CARRPM),R5	;MORE REVS MORE FRICTION
    // asm 00005372: 	SUBF	42,R5			;HEAVY FRICTION ABOVE 3900
    engine_friction_scale = C3X_SUB(C3X_LDF(carblk->rpm_x100), C3X_FROM_INT(42));
    // asm 00005373: 	LDFLT	0,R5
    if (C3X_LT(engine_friction_scale, C3X_FROM_INT(0))) {
        engine_friction_scale = C3X_IMM_F32(0);
    }
    // asm 00005374: 	MPYF	0.04,R5
    engine_friction_scale = C3X_MUL_IMM(engine_friction_scale, 0.04f);
    // asm 00005375: 	ADDF	1.0,R5			;APPROX RANGE 1-2
    engine_friction_scale = C3X_ADD_IMM(engine_friction_scale, 1.0f);
...
GETSPD2:
    ...
    for (frame = 0; frame < NFRAMES; frame++) {
        friction = C3X_MUL(speed, total_friction); // BRAKE/ROAD/ENGINE FRICTION
    // asm 0000537E: 	SUBF	R4,R1			;SUBTRACT FRICTION
        speed = C3X_SUB(speed, friction); // SUBTRACT FRICTION
    // asm 0000537F: 	ADDF	R0,R1			;ADD ACCEL
        speed = C3X_ADD(speed, acceleration); // ADD ACCEL
GSL0:
    // asm 00005380: ADDF	R1,R5			;ADD TO DISTANCE
        distance = C3X_ADD(distance, speed); // ADD TO DISTANCE
    }
    // asm 00005381: 	MPYF	1.5,R5			;SPEEDFUDGE
    distance = C3X_MUL_IMM(distance, 1.5f); // SPEEDFUDGE
    // asm 00005382: 	STF	R5,*+AR5(CARDIST)	;SAVE YOUR DISTANCE
    carblk->dist = C3X_STF(distance); // SAVE YOUR DISTANCE
    // asm 00005383: 	STF	R1,*+AR5(CARSPEED)	;NEW SPEED
    carblk->speed = C3X_STF(speed); // NEW SPEED
    MAME_ASSERT_REG_FLOAT(0x00005384, "R5", &distance);
    MAME_ASSERT_REG_FLOAT(0x00005384, "R1", &speed);
    // asm 00005384: 	RETS
    return distance;
}
...
FDL:
    ...
    if (track_obj != NULL && coded_id == (int)track_obj->usr1) {
        goto FDLX;
    }
    // asm 00005389: 	LDI	*+AR2(OLINK4),AR2
    track_obj = track_obj != NULL ? (OBJ*)track_obj->link4 : NULL;
    ...
    SLOCKON(1, "FIND_DYNA couldn't find road segment");
    // asm 0000538E: 	POP	R0
    // asm 0000538F: 	DIE
    return NULL;
FDLX:
...
int CKAHEAD(OBJ* other_obj /*AR2*/, CARBLK* other_carblk /*AR3*/, OBJ* obj /*AR4*/, CARBLK* carblk /*AR5*/) {
    ...
    int other_track_id;
    int track_id;
    c3x_reg_t obj_distance_sq;
    c3x_reg_t other_distance_sq;
    c3x_reg_t dx;
    c3x_reg_t dz;
    ...
    dx = C3X_SUB(track_obj->pos.X, obj->pos.X);
    dz = C3X_SUB(track_obj->pos.Z, obj->pos.Z);
    obj_distance_sq = C3X_ADD(C3X_MUL(dx, dx), C3X_MUL(dz, dz));
    ...
    dx = C3X_SUB(track_obj->pos.X, other_obj->pos.X);
    dz = C3X_SUB(track_obj->pos.Z, other_obj->pos.Z);
    other_distance_sq = C3X_ADD(C3X_MUL(dx, dx), C3X_MUL(dz, dz));
    // asm 000053AF: 	CMPF	R1,R0			;WHO IS CLOSER?
    // asm 000053B0: 	RETS
    if (C3X_LT(obj_distance_sq, other_distance_sq)) {
        return -1;
    }
    if (C3X_GT(obj_distance_sq, other_distance_sq)) {
        return 1;
    }
    return 0;
}
...
void CARSCAN(OBJ* obj /*AR4*/, CARBLK* carblk /*AR5*/) {
    ...
    obstacle_obj = CAR_LIST;
    // asm 000053B3: 	BZ	OBSCX
    if (obstacle_obj == NULL) {
        goto OBSCX;
    }
OBSCL:
    ...
    if ((obstacle_obj->flags & O_NOCOLL) != 0) {
        goto OBSCLP;
    }
    // asm 000053BA: 	LDI	2000H,R0
    // asm 000053BB: 	CALL	CARCHEK
    close_time = CARCHEK(obstacle_obj, obj, carblk, 0x2000);
    (void)close_time;
OBSCLP:
    // asm 000053BC: 	LDI	*+AR2(OLINK3),R0
    obstacle_obj = (OBJ*)(uintptr_t)obstacle_obj->link3;
...
void PLSCAN(OBJ* obj /*AR4*/, CARBLK* carblk /*AR5*/) {
    ...
    close_time = CARCHEK(player_obj, obj, carblk, 0x4000);
    // asm 000053C3: 	STI	R0,@PLYRCLOSE
    PLYRCLOSE = close_time;
    // asm 000053C4: 	RETS
    (void)player_carblk;
    return;
}
...
void OBSTABINIT(PROC* p /*AR7*/) {
    ...
    memset(ROADOBSTAB, 0, sizeof(ROADOBSTAB));
    // *CHICAGO KLUDGE
    // *GET CURRENT RACE
    ...
    if ((int)tracking_obj->usr1 < WACKER) {
        goto OIX;
    }
    // asm 000053D4: 	CMPI	@LAKEL,R1
    // asm 000053D5: 	BGT	OI1
    if ((int)tracking_obj->usr1 > LAKEL) {
        goto OI1;
    }
...
OILP00:
    ...
    for (i = 0; i < 27; i++) {
        ROADOBSTAB[table_offset + i] = block_value;
    }
    MAME_ASSERT_REGION_AT_ADDR(0x000053DE, "ROADOBSTAB", 0x0000E8DF, ROADOBSTAB, 50);
    // asm 000053DE: 	RETS
    return;
OI1:
...
OILP0:
    ...
    for (i = 0; i < 14; i++) {
        ROADOBSTAB[36 + i] = block_value;
        ROADOBSTAB[i] = block_value;
    }
    MAME_ASSERT_REGION_AT_ADDR(0x000053E8, "ROADOBSTAB", 0x0000E8DF, ROADOBSTAB, 50);
    // asm 000053E8: 	RETS
    return;
OI2:
    // asm 000053E9: 	STI	R0,*+AR0(36)
    ROADOBSTAB[36] = block_value;
    // asm 000053EA: 	STI	R0,*+AR0(37)		;EL TRACK PILLAR BLOCKOUT
    ROADOBSTAB[37] = block_value;
    // asm 000053EB: 	STI	R0,*+AR0(38)
    ROADOBSTAB[38] = block_value;
    // asm 000053EC:  	STI	R0,*+AR0(39)
    ROADOBSTAB[39] = block_value;
    // asm 000053ED: 	STI	R0,*+AR0(40)
    ROADOBSTAB[40] = block_value;
    // asm 000053EE: 	STI	R0,*+AR0(09)
    ROADOBSTAB[9] = block_value;
    // asm 000053EF: 	STI	R0,*+AR0(10)
    ROADOBSTAB[10] = block_value;
    // asm 000053F0: 	STI	R0,*+AR0(11)
    ROADOBSTAB[11] = block_value;
    // asm 000053F1: 	STI	R0,*+AR0(12)
    ROADOBSTAB[12] = block_value;
    // asm 000053F2: 	STI	R0,*+AR0(13)
    ROADOBSTAB[13] = block_value;
    MAME_ASSERT_REGION_AT_ADDR(0x000053F3, "ROADOBSTAB", 0x0000E8DF, ROADOBSTAB, 50);
    // asm 000053F3: 	RETS
    return;
    // *END CHICAGO KLUDGE
OI4:
    ...
    block_value = 0x1000;
    MAME_ASSERT_REG(0x000053F9, "R0", &block_value);
...
OILP:
    ...
    for (i = 0; i < 12; i++) {
        ROADOBSTAB[38 + i] = block_value;
        ROADOBSTAB[i] = block_value;
    }
OIX:
    MAME_ASSERT_MEM(0x000053FE, "d@e8df", &ROADOBSTAB[0]);
    // asm 000053FE: 	RETS
    return;
}
...
c3x_reg_t GETRDOFFSET(PROC* p /*AR7*/, OBJ* obj /*AR4*/, CARBLK* carblk /*AR5*/) {
    ...
    int gap_bits;
    int player_time;
    c3x_reg_t player_speed_delta;
    c3x_reg_t brake_factor;
    int scan_count;
    int overrun;
    int sequence_count;
    ...
    new_offset = C3X_MUL_IMM(C3X_NEG(carblk->dist_to_center), 0.01f); // ;DIVIDE BY 100
    // asm 00005403: 	FIX	R0
    table_index = FIX(new_offset);
    // asm 00005404: 	ADDI	21,R0	     	;LEFT EDGE OF ZONE
    table_index += 21; // ;LEFT EDGE OF ZONE
    ...
    gap_bits = ROADOBSTAB[table_index];
    // asm 0000540C: 	RPTS	6
    // asm 0000540D: 	OR	*AR0++,R1
    for (i = 1; i <= 7; i++) {
        gap_bits |= ROADOBSTAB[table_index + i];
    }
    ...
    player_time = gap_bits & 0x0FFF; // ;BRAKE IF REAL CLOSE...
    ...
    if (carblk->debug_car_id == (DRONE_C | VEHICLE_T | DRNE_COPCAR)) {
        goto S000;
    }
    ...
    player_speed_delta = C3X_SUB(PLYCBLK->speed, carblk->speed);
    // asm 0000541A: 	CMPF	10,R2
    // asm 0000541B: 	BGT	S000			;DONT BRAKE, PLAYER SPEED GREATER
    if (C3X_GT(player_speed_delta, C3X_FROM_INT(10))) {
        goto S000;
    }
    // asm 0000541C: 	FLOAT	R1
    // asm 0000541D: 	MPYF	0.01,R1			;BRAKE FACTOR CALC
    // asm 0000541E: 	ADDF	0.80,R1
    brake_factor = C3X_ADD_IMM(C3X_MUL_IMM(C3X_FROM_INT(player_time), 0.01f), 0.80f); // ;BRAKE FACTOR CALC
    // asm 0000541F: 	MPYF	*+AR5(CARSPEED),R1
    brake_factor = C3X_MUL(brake_factor, carblk->speed);
    // asm 00005420: 	STF	R1,*+AR5(CARSPEED)	;CUT SPEED
    carblk->speed = C3X_STF(brake_factor); // ;CUT SPEED
S00:
S000:
    // *WE HAVE AN OBSTACLE
    // *SCAN RIGHT 0--->49
...
SR0:
    while (scan_count > 0) {
        ...
        if (ROADOBSTAB[current_gap_index] != 0) {
            sequence_count = 0; // ;NON ZERO RESET COUNT
        }
...
FOUNDR:
    ...
    current_gap_index -= 4; // ;GET CENTER INDEX
    // asm 00005433: 	LDI	AR0,R6		;SAVE VALUE
    right_gap = current_gap_index;
    // *WE HAVE AN OBSTACLE
    // *SCAN LEFT 49--->0
LEFTSCAN:
    ...
    table_index += 29; // ;RT EDGE OF ZONE
    ...
    overrun = table_index - scan_count;
...
DONE:
    ...
    new_offset = C3X_MUL_IMM(p->ctx.RACER_DRONE.road_offset, 0.01f); // ;DIVIDE BY 100
    // asm 00005457: 	FIX	R0
    current_offset_index = FIX(new_offset);
    // asm 00005458: 	SUBI	R6,R0,R2		;FIND CLOSEST RT OR LFT
    right_delta = current_offset_index - right_gap; // ;FIND CLOSEST RT OR LFT
    // asm 00005459: 	SUBI	R7,R0,R3
    left_delta = current_offset_index - left_gap;
    // asm 0000545A: 	ABSI	R2
    right_delta = abs(right_delta);
    // asm 0000545B: 	ABSI	R3
    left_delta = abs(left_delta);
    ...
    new_offset = C3X_MUL_IMM(C3X_FROM_INT(table_index), 100); // ;NEW OFFSET
ROXX:
    // asm 00005462: ROXX
    // asm 00005462: 	RETS
...
static int CARCHEK(OBJ* obstacle_obj /*AR2*/, OBJ* obj /*AR4*/, CARBLK* carblk /*AR5*/, int table_code /*R0*/) {
    CARBLK* obstacle_carblk;
    c3x_reg_t delta_x;
    c3x_reg_t delta_z;
    c3x_reg_t distance_sq;
    c3x_reg_t side_clearance_sq;
    c3x_reg_t road_offset_delta;
    c3x_reg_t current_distance;
    c3x_reg_t next_distance;
    c3x_reg_t closing_delta;
    c3x_reg_t closing_rate;
    c3x_reg_t adjusted_delta_x;
    c3x_reg_t adjusted_delta_z;
    c3x_reg_t adjusted_distance;
    c3x_reg_t closing_frames;
    c3x_reg_t perpendicular_velocity;
    c3x_reg_t projected_offset;
    c3x_reg_t width;
    c3x_reg_t height;
    c3x_reg_t angle;
    int close_time;
    ...
    obstacle_carblk = obstacle_obj->carblk;
    // asm 00005468: 	CALL	CKAHEAD
    // asm 00005469: 	BN	CARCHKX 		;CAR BEHIND, IGNORE
    if (CKAHEAD(obstacle_obj, obstacle_carblk, obj, carblk) < 0) {
        goto CARCHKX;
    }
    // *GET CURRENT DISTANCE
    // asm 0000546A: 	SUBF	*+AR4(OPOSX),*+AR2(OPOSX),R6
    delta_x = C3X_SUB(obstacle_obj->pos.X, obj->pos.X);
    // asm 0000546B: 	LDF	*+AR2(OPOSZ),R7
    // asm 0000546C: 	SUBF	*+AR4(OPOSZ),R7
    delta_z = C3X_SUB(obstacle_obj->pos.Z, obj->pos.Z);
    ...
    if (C3X_LT(C3X_MUL(C3X_FROM_INT(30000), C3X_FROM_INT(30000)), distance_sq)) {
        goto CARCHKX;
    }
    ...
    side_clearance_sq = C3X_ADD(C3X_ADD(obstacle_carblk->z_plus, carblk->z_plus), C3X_FROM_INT(200)); // ;LEAVE A LITTLE ROOM
    side_clearance_sq = C3X_MUL(side_clearance_sq, side_clearance_sq);                                // ;GET 1/2 Z1+Z2 SQUARED
    // asm 00005478: 	CMPF	R1,R2			;CLOSE ENOUGH ?
    // asm 00005479: 	BGT	SIDECKX			;NO...
    if (C3X_GT(distance_sq, side_clearance_sq)) {
        goto SIDECKX;
    }
    // asm 0000547A: 	LDF     *+AR5(CARDIST2CNTR),R1
    // asm 0000547B: 	SUBF	*+AR3(CARDIST2CNTR),R1
    // asm 0000547C: 	ABSF	R1
    road_offset_delta = C3X_ABS(C3X_SUB(carblk->dist_to_center, obstacle_carblk->dist_to_center));
    // asm 0000547D: 	FLOAT	400,R3
    // asm 0000547E: 	CMPF	R3,R1
    // asm 0000547F: 	BLT	SIDECKX			;OFFSET TOO CLOSE
    if (C3X_LT(road_offset_delta, C3X_FROM_INT(400))) {
        goto SIDECKX;
    }
    // asm 00005480: 	LDF	10,R0
    closing_frames = C3X_FROM_INT(10);
    // asm 00005481: 	PUSHF	R0
    // asm 00005482: 	B	GOTONE
    goto GOTONE;
SIDECKX:
    // asm 00005483: 	CALL	SQRT
    current_distance = SQRT(distance_sq);
    ...
    delta_x = C3X_SUB(delta_x, C3X_MUL(C3X_NEG(_SINE(C3X_LDF(carblk->y_velocity_rotation))), carblk->speed));
    // asm 0000548D: 	SUBF	R4,R7
    delta_z = C3X_SUB(delta_z, C3X_MUL(_COSI(C3X_LDF(carblk->y_velocity_rotation)), carblk->speed));
    // *CAR 1 T+1
    ...
    delta_x = C3X_ADD(delta_x, C3X_MUL(C3X_NEG(_SINE(C3X_LDF(obstacle_carblk->y_velocity_rotation))), obstacle_carblk->speed));
    // asm 00005496: 	ADDF	R4,R7
    delta_z = C3X_ADD(delta_z, C3X_MUL(_COSI(C3X_LDF(obstacle_carblk->y_velocity_rotation)), obstacle_carblk->speed));
    ...
    next_distance = SQRT(distance_sq); // ;DISTANCE T+1
    // asm 0000549B: 	SUBF	R5,R0
    closing_delta = C3X_SUB(next_distance, current_distance);
    // asm 0000549C: 	BGE	CARCHKX			;MOVING APART
    if (C3X_GE(closing_delta, C3X_FROM_INT(0))) {
        goto CARCHKX;
    }
    // *FIND CLOSING RATE
    // asm 0000549D: 	ABSF	R0,R1
    // asm 0000549E:  	MPYF	1.5,R1			;VELOCITY FUDGE FACTOR
    closing_rate = C3X_MUL_IMM(C3X_ABS(closing_delta), 1.5f); // ;VELOCITY FUDGE FACTOR
    ...
    adjusted_delta_x = C3X_SUB(C3X_ABS(delta_x), C3X_FROM_INT(400)); // ;ADJUST DELTA X FOR CAR	THICKNESS
    if (C3X_LT(adjusted_delta_x, C3X_FROM_INT(0))) {
        adjusted_delta_x = C3X_FROM_INT(0);
    }
    ...
    adjusted_delta_z = C3X_SUB(C3X_ABS(delta_z), C3X_FROM_INT(1000)); // ;ADJUST DELTA Z FOR CAR THICKNESS
    if (C3X_LT(adjusted_delta_z, C3X_FROM_INT(0))) {
        adjusted_delta_z = C3X_FROM_INT(0);
    }
    // asm 000054A7: 	MPYF	R6,R6,R0
    // asm 000054A8: 	MPYF	R7,R7,R2
    // asm 000054A9: 	ADDF	R0,R2			;distance^2
    adjusted_distance = C3X_ADD(C3X_MUL(adjusted_delta_x, adjusted_delta_x), C3X_MUL(adjusted_delta_z, adjusted_delta_z));
    // asm 000054AA: 	CALL	SQRT			;DISTANCE T+1
    adjusted_distance = SQRT(adjusted_distance); // ;DISTANCE T+1
    // asm 000054AB: 	CALL	DIV_F			;CLOSING FRAMES
    closing_frames = DIV_F(adjusted_distance, closing_rate); // ;CLOSING FRAMES
    // asm 000054AC: 	CMPF	200,R0
    // asm 000054AD: 	BGT	CARCHKX			;TOO FAR AWAY
    if (C3X_GT(closing_frames, C3X_FROM_INT(200))) {
        goto CARCHKX;
    }
...
GOTONE:
    ...
    projected_offset = C3X_MUL(closing_frames, perpendicular_velocity); // ;PROJECTED OFFSET
    // asm 000054B2: 	FIX	R1,IR1			;SAVE TIME
    close_time = FIX(closing_frames); // ;SAVE TIME
    // asm 000054B3: 	SUBF	*+AR3(CARDIST2CNTR),R2
    projected_offset = C3X_SUB(projected_offset, obstacle_carblk->dist_to_center);
    // asm 000054B4: 	MPYF	0.01,R2
    projected_offset = C3X_MUL_IMM(projected_offset, 0.01f);
    // asm 000054B5: 	FIX	R2,IR0
    // asm 000054B6: 	ADDI	25,IR0			;ADJUST FOR ROAD CENTER (25), CAR THICKNESS (4)
    table_index = FIX(projected_offset);
    table_index += 25; // ;ADJUST FOR ROAD CENTER (25), CAR THICKNESS (4)
    // asm 000054B7: 	CALL	GETWIDTH		;GET CAR WIDTH
    GETWIDTH(obstacle_obj, obstacle_carblk, &width, &height); // ;GET CAR WIDTH
    // asm 000054B8: 	MPYF	0.01,R0
    width = C3X_MUL_IMM(width, 0.01f);
    // asm 000054B9: 	ABSF	R0
    width = C3X_ABS(width);
    // asm 000054BA: 	CMPF	20,R0
    // asm 000054BB: 	LDFGT	20,R0
    if (C3X_GT(width, C3X_FROM_INT(20))) {
        width = C3X_FROM_INT(20);
    }
    // asm 000054BC: 	FIX	R0,R0
    // asm 000054BD: 	ADDI	3,R0
    width_count = FIX(width) + 3;
    // asm 000054BE: 	LDI	R0,RC			;WIDTH COUNT
    // asm 000054BF: 	LSH	-1,R0			;DIVIDE BY 2
    // asm 000054C0: 	SUBI	R0,IR0			;CENTER UP CAR AREA
    table_index -= width_count >> 1; // ;CENTER UP CAR AREA
    // asm 000054C1: 	LDI	@ROADOBSTABI,AR0
    // asm 000054C2: 	LDI	@CARTMP1,R1		;GET CODE TO STORE
    // asm 000054C3: 	ADDI	IR1,R1			;ADD IN THE TIME
    store_value = CARTMP1 + close_time; // ;ADD IN THE TIME
    ...
    for (i = 0; i <= width_count; i++) {
        ...
        ROADOBSTAB[table_index] = store_value;
    LOADLP:
...
LOADLPX:
    ...
    MAME_ASSERT_REG(0x000054CC, "R0", &close_time);
    // asm 000054CC: 	RETS
    return close_time;
CARCHKX:
...
static c3x_reg_t GETPV(OBJ* obj /*AR2*/, CARBLK* carblk /*AR3*/, c3x_reg_t* angle_out /*R2*/) {
    ...
    angle = C3X_SUB(angle, carblk->y_velocity_rotation);
    // asm 000054D4: 	LDF	R0,R2
    if (angle_out != NULL) {
        *angle_out = angle;
    }
    // asm 000054D5: 	CALL	_SINE
    perpendicular_velocity = _SINE(angle);
    // asm 000054D6: 	MPYF	*+AR3(CARSPEED),R0
    perpendicular_velocity = C3X_MUL(perpendicular_velocity, carblk->speed);
    // asm 000054D7: 	MPYF	1.5,R0
    perpendicular_velocity = C3X_MUL_IMM(perpendicular_velocity, 1.5f);
...
static void GETWIDTH(OBJ* obj /*AR2*/, CARBLK* carblk /*AR3*/, c3x_reg_t* width_out /*R0*/, c3x_reg_t* height_out /*R1*/) {
    ...
    x_width = C3X_SUB(carblk->x_plus, carblk->x_minus);
    // asm 000054E5: 	LDF	*+AR3(CARZPLUS),R3
    // asm 000054E6: 	SUBF	*+AR3(CARZMINUS),R3
    z_width = C3X_SUB(carblk->z_plus, carblk->z_minus);
    // asm 000054E7: 	ABSF	R0
    cosine = C3X_ABS(cosine);
    // asm 000054E8: 	ABSF	R1
    sine = C3X_ABS(sine);
    // asm 000054E9: 	MPYF	R0,R2,R4	     	;COS*X+SIN*Z WIDTH TERMS
    // asm 000054EA: 	MPYF	R1,R3,R5
    width = C3X_ADD(C3X_MUL(cosine, x_width), C3X_MUL(sine, z_width)); // ;COS*X+SIN*Z WIDTH TERMS
    // asm 000054EB: 	MPYF	R1,R2,R2		;SIN*X+COS*Z HEIGHT TERMS
    // asm 000054EC: 	MPYF	R0,R3,R3
    height = C3X_ADD(C3X_MUL(sine, x_width), C3X_MUL(cosine, z_width)); // ;SIN*X+COS*Z HEIGHT TERMS
...
RPASS1:
    ...
    if (C3X_GT(speed_difference, C3X_FROM_INT(40))) {
        goto RPASS2;
    }
    // asm 000054FC: 	ABSF	R3
    speed_difference = C3X_ABS(speed_difference);
    // asm 000054FD: 	CMPF	20,R3
    // asm 000054FE: 	BLT	RPASSX
    if (C3X_LT(speed_difference, C3X_FROM_INT(20))) {
        goto RPASSX;
    }
    // asm 000054FF: 	CMPF	60,R3
    // asm 00005500: 	LDFGT	60,R3
    if (C3X_GT(speed_difference, C3X_FROM_INT(60))) {
        speed_difference = C3X_FROM_INT(60);
    }
...
RPASS3:
    ...
    lateral_difference = C3X_SUB(carblk->dist_to_center, player_carblk->dist_to_center);
    // asm 0000550E: 	ABSF	R0,R1
    lateral_difference = C3X_ABS(lateral_difference);
    // asm 0000550F: 	FLOAT	4000,R0
    // asm 00005510: 	CALL	DIV_F
    volume_factor = DIV_F(C3X_FROM_INT(4000), lateral_difference);
    // asm 00005511: 	CMPF	1.0,R0
    // asm 00005512: 	LDFGT	1.0,R0
    if (C3X_GT(volume_factor, C3X_FROM_INT(1))) {
        volume_factor = C3X_FROM_INT(1);
    }
    // asm 00005513: 	FLOAT	255,R1
    // asm 00005514: 	MPYF	R1,R0			;VOLUME FACTOR
    volume_factor = C3X_MUL(volume_factor, C3X_FROM_INT(255));
    // asm 00005515: 	FIX	R0
    volume = FIX(volume_factor);
    MAME_ASSERT_REG(0x00005516, "R0", &volume);
    // asm 00005516: 	LDI	SMCARPASS,AR2		;DIFFERENT SOUND DIFF VEL
    sound_index = SMCARPASS;
    // asm 00005517: 	CMPF	40,R3
    // asm 00005518: 	LDIGT	FCARPASS,AR2
    if (C3X_GT(speed_difference, C3X_FROM_INT(40))) {
        sound_index = FCARPASS;
    }
    // asm 00005519: 	CMPF	60,R3
    // asm 0000551A: 	BLT	RPASS4
    if (C3X_LT(speed_difference, C3X_FROM_INT(60))) {
        goto RPASS4;
    }
    // asm 0000551B: 	FIX	R3
    // asm 0000551C: 	LSH	-1,R3
    // asm 0000551D: 	LDIC	SPCARPASS,AR2
    if ((FIX(speed_difference) & 1) != 0) {
        sound_index = SPCARPASS;
    }
RPASS4:
    // asm 0000551E: 	CALL	VOLSNDFX
    MAME_ASSERT_REG(0x0000551E, "AR2", &sound_index);
...
c3x_reg_t SPOS_INIT(PROC* p /*AR7*/, OBJ* obj /*AR4*/, OBJ* tracking_obj /*AR2*/, int rank_forward /*AR3*/) {
    ...
    _VECTORB.X = C3X_STF(C3X_REG(tracking_obj->pos.X));
    // asm 00005527: 	LDF	*+AR2(OPOSY),R0
    // asm 00005528: 	STF	R0,*+AR5(Y)
    _VECTORB.Y = C3X_STF(C3X_REG(tracking_obj->pos.Y));
    // asm 00005529: 	LDF	*+AR2(OPOSZ),R0
    // asm 0000552A: 	STF	R0,*+AR5(Z)
    _VECTORB.Z = C3X_STF(C3X_REG(tracking_obj->pos.Z));
    carblk = obj->carblk;
...
LOOP56:
    ...
    delta_x = C3X_SUB(tracking_obj->pos.X, _VECTORB.X);
    delta_z = C3X_SUB(tracking_obj->pos.Z, _VECTORB.Z);
    road_theta = C3X_SUB_IMM(ARCTANF(delta_x, delta_z), HALFPI);
    // asm 00005533: 	CMPI	0,AR3
    // asm 00005534: 	BEQ	OFFANDDONE
    if (rank_forward != 0) {
        // asm 00005535: 	FLOAT	5500,R0
        // asm 00005536: 	CALL	DISTANCE_2D
        distance = C3X_FROM_INT(5500);
        // asm 00005537: 	ADDF	*+AR5(X),R0
        // asm 00005538: 	STF	R0,*+AR5(X)
        _VECTORB.X = C3X_STF(C3X_ADD(_VECTORB.X, C3X_MUL(C3X_NEG(_SINE(road_theta)), distance)));
        // asm 00005539: 	ADDF	*+AR5(Z),R1
        // asm 0000553A: 	STF	R1,*+AR5(Z)
        _VECTORB.Z = C3X_STF(C3X_ADD(_VECTORB.Z, C3X_MUL(_COSI(road_theta), distance)));
        ...
        LOOP56A:
            ...
            while (1) {
                ...
                delta_z = C3X_SUB(tracking_obj->pos.Z, _VECTORB.Z);
                distance_sq = C3X_ADD(C3X_MUL(delta_x, delta_x), C3X_MUL(delta_z, delta_z));
                if (C3X_GT(SQRT(distance_sq), C3X_FROM_INT(5000))) {
                    goto LOOP56;
                }
                tracking_obj = (OBJ*)tracking_obj->link4;
            }
...
L874:
    ...
    obj->pos.X = C3X_STF(C3X_ADD(_VECTORB.X, _VECTORA.X));
    ...
    y_position = C3X_SUB(C3X_LDF(_VECTORB.Y), C3X_FROM_RAW32(CLIPRAM[25]));
    ...
    obj->pos.Z = C3X_STF(C3X_ADD(_VECTORB.Z, _VECTORA.Z));
    MAME_ASSERT_REG_FLOAT(0x00005562, "R0", &obj->pos.Z);
...
WRKST1:
    ...
    p->ctx.CARPROC.wreck_x_rate = C3X_STF_IMM(0.104); // ;X RADIANS
    // asm 00005579: 	LDF	0.104,R0
    // asm 0000557A: 	STF	R0,*+AR7(PDATA+1)	;Y RADIANS
    p->ctx.CARPROC.wreck_y_rate = C3X_STF_IMM(0.104); // ;Y RADIANS
    // asm 0000557B: 	LDF	0,R0
    // asm 0000557C: 	STF	R0,*+AR7(PDATA+2)	;Z RADIANS
    p->ctx.CARPROC.wreck_z_rate = C3X_STF_IMM(0); // ;Z RADIANS
    // asm 0000557D: 	LDF	0,R0
    // asm 0000557E: 	STF	R0,*+AR7(PDATA+3)	;X RADIAN TOTAL
    p->ctx.CARPROC.wreck_x_total = C3X_STF_IMM(0); // ;X RADIAN TOTAL
    // asm 0000557F: 	STF	R0,*+AR7(PDATA+5)  	;Z RADIAN TOTAL
    p->ctx.CARPROC.wreck_z_total = C3X_STF_IMM(0); // ;Z RADIAN TOTAL
    ...
    obj->vel_y = C3X_STF_IMM(-60); // ;STUFF VERTICAL VELOCITY
...
void WRECK(OBJ* obj /*AR4*/, CARBLK* carblk /*AR5*/, PROC* p /*AR7*/) {
    ...
    angle = C3X_ADD_IMM(C3X_LDF(carblk->y_velocity_rotation), 1.57); // ;CORRECT FOR 90 DEGREE ERROR
...
WRECK1:
    ...
    vertical_velocity = C3X_ADD(C3X_MUL_IMM(C3X_FROM_INT(NFRAMES), 2), C3X_LDF(obj->vel_y)); // ;FRAME ADJUSTED GRAVITY
    obj->vel_y = C3X_STF(vertical_velocity);
    // asm 000055B5: 	CMPF	60,R2
    // asm 000055B6: 	RETSLT				;NOT OVER YET
    if (C3X_LT_IMM(vertical_velocity, 60)) {
