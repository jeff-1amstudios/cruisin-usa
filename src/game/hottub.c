...
void BABE_WAVEFLAG(PROC* p) {
    ...
    p->ctx->BABE_WAVEFLAG.obj->pos.X = C3X_FROM_INT(-350);
    // asm 00008BDC: 	STF	R0,*+AR4(OPOSX)
    // asm 00008BDD: 	FLOAT	40,R0
    p->ctx->BABE_WAVEFLAG.obj->pos.Y = C3X_FROM_INT(40);
    // asm 00008BDE: 	STF	R0,*+AR4(OPOSY)
    // asm 00008BDF: 	FLOAT	368,R0
    p->ctx->BABE_WAVEFLAG.obj->pos.Z = C3X_FROM_INT(368);
...
BABEWTLP:
    ...
    if (C3X_LT(p->ctx->BABE_WAVEFLAG.obj->pos.X, C3X_FROM_INT(-200))) {
        ...
        p->ctx->BABE_WAVEFLAG.obj->pos.X = C3X_ADD(p->ctx->BABE_WAVEFLAG.obj->pos.X, C3X_FROM_INT(5));
...
BABEOFF:
    ...
    p->ctx->BABE_WAVEFLAG.obj->pos.X = C3X_SUB(p->ctx->BABE_WAVEFLAG.obj->pos.X, C3X_FROM_INT(6));
