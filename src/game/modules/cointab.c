...
/* asm: COIN_TABLEI	.word	COIN_TABLE */
int COIN_TABLEI = (int)(COIN_TABLE);
/* asm: COIN_TABLEENDI	.word	COIN_TABLEEND */
int COIN_TABLEENDI = (int)(COIN_TABLEEND);
/* asm: COUNTRY_TABI	.word	COUNTRY_TAB */
int COUNTRY_TABI = (int)(COUNTRY_TAB);
/* asm: COUNTRY_DEFAULTSI	.word	COUNTRY_DEFAULTS */
int COUNTRY_DEFAULTSI = (int)(COUNTRY_DEFAULTS);
/* asm: COINMSGC_TABI	.word	COINMSGC_TAB */
int COINMSGC_TABI = (int)(COINMSGC_TAB);
/* asm: COUNTRY_DEFAULTS_ENDI	.word	COUNTRY_DEFAULTS_END */
int COUNTRY_DEFAULTS_ENDI = (int)(COUNTRY_DEFAULTS_END);
