...
#define M4ST HALFPI
// 	;THETA DELTAs
#define M1STD 0.052359877
#define M2STD (-0.052359877)
#define M3STD 0.052359877
#define M4STD (-0.052359877)
// 	;PROCESS DATA DEFINEs
#define MAP1OBJ (PDATA+0)
#define MAP2OBJ (PDATA+1)
#define MAP3OBJ (PDATA+2)
#define MAP4OBJ (PDATA+3)
#define MAPLPX (PDATA+4)
#define MAPLPY (PDATA+5)
#define MAPLPZ (PDATA+6)
#define MAP1T (PDATA+7)
#define MAP2T (PDATA+8)
#define MAP3T (PDATA+9)
#define MAP4T (PDATA+10)
#define MAPLTX (PDATA+11)
#define MAPLMAT (PDATA+12)
