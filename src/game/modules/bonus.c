...
int BONUS_TABLE[] = { BONUS1, BONUS2, BONUS3, BONUS4, BONUS5, BONUS6, BONUS7, BONUS8, BONUS9, BONUS10, BONUS11, BONUS12, BONUS13, BONUS14 };
// *----------------------------------------------------------------------------
...
CONTINUE:
    ...
    // asm: 	CALL	CLEAR_LINK	;WE ARE NOW *NOT* LINKED
    // asm: 	SOND1	MAPTUNE
    // asm: 	LDI	@DID_TIMED_OUT,R0
    // asm: 	BZ	PAPAPA44
    // asm: 	LDI	@POSITION,R0
