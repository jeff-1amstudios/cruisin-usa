...
extern int PLMSAV[];
extern int PMSAV[];
extern float ROADFRICI;
extern float OFRDFRICI;
extern float BRAKFRICI;
extern float SKIDFRICI;
extern float SPINFRICI;
extern int CARPARAMTAB[];
extern int CARPARAMTAB1[];
extern float CATCHUP;
extern float AHEAD;
extern float DISTCON;
extern float SPDCON;
...
void SOFTCURB(void)
{
    ...
    // asm 00003015: SOFTVEL	LDF	*+AR5(CARSPEED),R0	;MINIMUM SPEED
    ...
    // asm 0000302A: SOFT20	SUBF	R2,R5
