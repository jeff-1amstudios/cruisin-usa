...
void WAVE(int wave_index) {
    ...
    _CAMERARAD.X = C3X_FROM_INT(0);
    _CAMERARAD.Y = C3X_FROM_INT(0);
    _CAMERARAD.Z = C3X_FROM_INT(0);
    _CAMERAPOS.X = C3X_FROM_INT(0);
    _CAMERAPOS.Y = C3X_FROM_INT(0);
    _CAMERAPOS.Z = C3X_FROM_INT(0);
    _LIGHT.Z = C3X_FROM_INT(0);
    _LIGHT.X = C3X_IMM_F32(0.707f);
    _LIGHT.Y = C3X_IMM_F32(0.707f);
...
static DYNATAB COPCARTAB = {
    .count_minus_1 = 5,
    .entries = {
        { { C3X_INIT(0.0f, 0x8000000000ull), C3X_INIT(101.0f, 0x064a000000ull), C3X_INIT(0.0f, 0x8000000000ull) }, 3, DYNAF_SHADOW },           // SHADOW
        { { C3X_INIT(192.0f, 0x0740000000ull), C3X_INIT(101.0f, 0x064a000000ull), C3X_INIT(-301.0f, 0x08E9800000ull) }, 23, DYNAF_REARWHEEL },  // RT REAR WHEEL XYZ CENTER OFFSET
        { { C3X_INIT(208.0f, 0x0750000000ull), C3X_INIT(101.0f, 0x064a000000ull), C3X_INIT(371.0f, 0x0839800000ull) }, 23, DYNAF_FRONTWHEEL },  // RT FRONT WHEEL XYZ CENTER OFFSET
        { { C3X_INIT(-192.0f, 0x07C0000000ull), C3X_INIT(101.0f, 0x064a000000ull), C3X_INIT(-301.0f, 0x08E9800000ull) }, 23, DYNAF_REARWHEEL }, // LFT REAR WHEEL XYZ CENTER OFFSET
        { { C3X_INIT(-208.0f, 0x07B0000000ull), C3X_INIT(101.0f, 0x064a000000ull), C3X_INIT(371.0f, 0x0839800000ull) }, 23, DYNAF_FRONTWHEEL }, // LFT FRONT WHEEL XYZ CENTER OFFSET
        { { C3X_INIT(0.0f, 0x8000000000ull), C3X_INIT(0.0f, 0x8000000000ull), C3X_INIT(0.0f, 0x8000000000ull) }, 72 - 1, DYNAF_BODY },          // BODY XYZ CENTER OFFSET
    },
};
// *----------------------------------------------------------------------------
...
static DYNATAB HOTRODTAB = {
    .count_minus_1 = 5,
    .entries = {
        { { C3X_INIT(0.0f, 0x8000000000ull), C3X_INIT(117.0f, 0x066a000000ull), C3X_INIT(0.0f, 0x8000000000ull) }, 3, DYNAF_SHADOW },           // SHADOW
        { { C3X_INIT(211.0f, 0x0753000000ull), C3X_INIT(100.0f, 0x0648000000ull), C3X_INIT(-329.0f, 0x08DB800000ull) }, 23, DYNAF_REARWHEEL },  // RT REAR WHEEL XYZ CENTER OFFSET
        { { C3X_INIT(221.0f, 0x075d000000ull), C3X_INIT(100.0f, 0x0648000000ull), C3X_INIT(414.0f, 0x084f000000ull) }, 23, DYNAF_FRONTWHEEL },  // RT FRONT WHEEL XYZ CENTER OFFSET
        { { C3X_INIT(-211.0f, 0x07AD000000ull), C3X_INIT(100.0f, 0x0648000000ull), C3X_INIT(-329.0f, 0x08DB800000ull) }, 23, DYNAF_REARWHEEL }, // LFT REAR WHEEL XYZ CENTER OFFSET
        { { C3X_INIT(-221.0f, 0x07A3000000ull), C3X_INIT(100.0f, 0x0648000000ull), C3X_INIT(414.0f, 0x084f000000ull) }, 23, DYNAF_FRONTWHEEL }, // LFT FRONT WHEEL XYZ CENTER OFFSET
        { { C3X_INIT(0.0f, 0x8000000000ull), C3X_INIT(0.0f, 0x8000000000ull), C3X_INIT(0.0f, 0x8000000000ull) }, 131, DYNAF_BODY },             // BODY XYZ CENTER OFFSET
    },
};
/* asm: TESTORTAB */
/* asm: 	.word	5		;#OF DYNAS-1 */
...
static DYNATAB TESTORTAB = {
    .count_minus_1 = 5,
    .entries = {
        { { C3X_INIT(0.0f, 0x8000000000ull), C3X_INIT(62.0f, 0x0578000000ull), C3X_INIT(0.0f, 0x8000000000ull) }, 3, DYNAF_SHADOW },           // SHADOW
        { { C3X_INIT(251.0f, 0x077b000000ull), C3X_INIT(62.0f, 0x0578000000ull), C3X_INIT(-333.0f, 0x08D9800000ull) }, 23, DYNAF_REARWHEEL },  // RT REAR WHEEL XYZ CENTER OFFSET
        { { C3X_INIT(251.0f, 0x077b000000ull), C3X_INIT(62.0f, 0x0578000000ull), C3X_INIT(285.0f, 0x080e800000ull) }, 23, DYNAF_FRONTWHEEL },  // RT FRONT WHEEL XYZ CENTER OFFSET
        { { C3X_INIT(-251.0f, 0x0785000000ull), C3X_INIT(62.0f, 0x0578000000ull), C3X_INIT(285.0f, 0x080e800000ull) }, 23, DYNAF_FRONTWHEEL }, // LFT FRONT WHEEL XYZ CENTER OFFSET
        { { C3X_INIT(-251.0f, 0x0785000000ull), C3X_INIT(62.0f, 0x0578000000ull), C3X_INIT(-333.0f, 0x08D9800000ull) }, 23, DYNAF_REARWHEEL }, // LFT REAR WHEEL XYZ CENTER OFFSET
        { { C3X_INIT(0.0f, 0x8000000000ull), C3X_INIT(0.0f, 0x8000000000ull), C3X_INIT(0.0f, 0x8000000000ull) }, 59, DYNAF_BODY },             // BODY XYZ CENTER OFFSET
    },
};
/*
 *
...
static DYNATAB JEEPTAB = {
    .count_minus_1 = 5,
    .entries = {
        { { C3X_INIT(0.0f, 0x8000000000ull), C3X_INIT(119.0f, 0x066e000000ull), C3X_INIT(0.0f, 0x8000000000ull) }, 3, DYNAF_SHADOW },           // SHADOW
        { { C3X_INIT(250.0f, 0x077a000000ull), C3X_INIT(131.0f, 0x0703000000ull), C3X_INIT(-285.0f, 0x08F1800000ull) }, 23, DYNAF_REARWHEEL },  // RT REAR WHEEL XYZ CENTER OFFSET
        { { C3X_INIT(250.0f, 0x077a000000ull), C3X_INIT(131.0f, 0x0703000000ull), C3X_INIT(355.0f, 0x0831800000ull) }, 23, DYNAF_FRONTWHEEL },  // RT FRONT WHEEL XYZ CENTER OFFSET
        { { C3X_INIT(-250.0f, 0x0786000000ull), C3X_INIT(131.0f, 0x0703000000ull), C3X_INIT(-285.0f, 0x08F1800000ull) }, 23, DYNAF_REARWHEEL }, // LFT REAR WHEEL XYZ CENTER OFFSET
        { { C3X_INIT(-250.0f, 0x0786000000ull), C3X_INIT(131.0f, 0x0703000000ull), C3X_INIT(357.0f, 0x0832800000ull) }, 23, DYNAF_FRONTWHEEL }, // LFT FRONT WHEEL XYZ CENTER OFFSET
        { { C3X_INIT(0.0f, 0x8000000000ull), C3X_INIT(0.0f, 0x8000000000ull), C3X_INIT(0.0f, 0x8000000000ull) }, 62, DYNAF_BODY },              // BODY XYZ CENTER OFFSET
    },
};
/*
 *
...
static DYNATAB VETTTAB = {
    .count_minus_1 = 5,
    .entries = {
        { { C3X_INIT(0.0f, 0x8000000000ull), C3X_INIT(-164.0f, 0x07DC000000ull), C3X_INIT(0.0f, 0x8000000000ull) }, 3, DYNAF_SHADOW },         // SHADOW
        { { C3X_INIT(254.0f, 0x077e000000ull), C3X_INIT(67.0f, 0x0606000000ull), C3X_INIT(-296.0f, 0x08EC000000ull) }, 23, DYNAF_REARWHEEL },  // RT REAR WHEEL XYZ CENTER OFFSET
        { { C3X_INIT(228.0f, 0x0764000000ull), C3X_INIT(81.0f, 0x0622000000ull), C3X_INIT(376.0f, 0x083c000000ull) }, 23, DYNAF_FRONTWHEEL },  // RT FRONT WHEEL XYZ CENTER OFFSET
        { { C3X_INIT(-254.0f, 0x0782000000ull), C3X_INIT(67.0f, 0x0606000000ull), C3X_INIT(-296.0f, 0x08EC000000ull) }, 23, DYNAF_REARWHEEL }, // LFT REAR WHEEL XYZ CENTER OFFSET
        { { C3X_INIT(-228.0f, 0x079C000000ull), C3X_INIT(81.0f, 0x0622000000ull), C3X_INIT(376.0f, 0x083c000000ull) }, 23, DYNAF_FRONTWHEEL }, // LFT FRONT WHEEL XYZ CENTER OFFSET
        { { C3X_INIT(0.0f, 0x8000000000ull), C3X_INIT(0.0f, 0x8000000000ull), C3X_INIT(0.0f, 0x8000000000ull) }, 114, DYNAF_BODY },            // BODY XYZ CENTER OFFSET
    },
};
/*
 *
...
static DYNATAB GTRUCKTABP = {
    .count_minus_1 = 5,
    .entries = {
        { { C3X_INIT(0.0f, 0x8000000000ull), C3X_INIT(-117.0f, 0x0696000000ull), C3X_INIT(0.0f, 0x8000000000ull) }, 3, DYNAF_SHADOW },         // SHADOW
        { { C3X_INIT(259.0f, 0x0801800000ull), C3X_INIT(86.0f, 0x062c000000ull), C3X_INIT(-358.0f, 0x08CD000000ull) }, 23, DYNAF_REARWHEEL },  // RT REAR WHEEL XYZ CENTER OFFSET
        { { C3X_INIT(248.0f, 0x0778000000ull), C3X_INIT(90.0f, 0x0634000000ull), C3X_INIT(388.0f, 0x0842000000ull) }, 23, DYNAF_FRONTWHEEL },  // RT FRONT WHEEL XYZ CENTER OFFSET
        { { C3X_INIT(-259.0f, 0x08FE800000ull), C3X_INIT(86.0f, 0x062c000000ull), C3X_INIT(-358.0f, 0x08CD000000ull) }, 23, DYNAF_REARWHEEL }, // LFT REAR WHEEL XYZ CENTER OFFSET
        { { C3X_INIT(-248.0f, 0x0788000000ull), C3X_INIT(90.0f, 0x0634000000ull), C3X_INIT(388.0f, 0x0842000000ull) }, 23, DYNAF_FRONTWHEEL }, // LFT FRONT WHEEL XYZ CENTER OFFSET
        { { C3X_INIT(0.0f, 0x8000000000ull), C3X_INIT(0.0f, 0x8000000000ull), C3X_INIT(0.0f, 0x8000000000ull) }, 131, DYNAF_BODY },            // BODY XYZ CENTER OFFSET
    },
};
/*
...
static DYNATAB PSBUSTAB = {
    .count_minus_1 = 5,
    .entries = {
        { { C3X_INIT(0.0f, 0x8000000000ull), C3X_INIT(-127.0f, 0x0682000000ull), C3X_INIT(0.0f, 0x8000000000ull) }, 3, DYNAF_SHADOW },          // SHADOW
        { { C3X_INIT(246.0f, 0x0776000000ull), C3X_INIT(127.0f, 0x067e000000ull), C3X_INIT(-380.0f, 0x08C2000000ull) }, 23, DYNAF_REARWHEEL },  // RT REAR WHEEL XYZ CENTER OFFSET
        { { C3X_INIT(247.0f, 0x0777000000ull), C3X_INIT(127.0f, 0x067e000000ull), C3X_INIT(573.0f, 0x090f400000ull) }, 23, DYNAF_FRONTWHEEL },  // RT FRONT WHEEL XYZ CENTER OFFSET
        { { C3X_INIT(-247.0f, 0x0789000000ull), C3X_INIT(127.0f, 0x067e000000ull), C3X_INIT(-380.0f, 0x08C2000000ull) }, 23, DYNAF_REARWHEEL }, // LFT REAR WHEEL XYZ CENTER OFFSET
        { { C3X_INIT(-247.0f, 0x0789000000ull), C3X_INIT(127.0f, 0x067e000000ull), C3X_INIT(573.0f, 0x090f400000ull) }, 23, DYNAF_FRONTWHEEL }, // LFT FRONT WHEEL XYZ CENTER OFFSET
        { { C3X_INIT(0.0f, 0x8000000000ull), C3X_INIT(0.0f, 0x8000000000ull), C3X_INIT(0.0f, 0x8000000000ull) }, 91, DYNAF_BODY },              // BODY XYZ CENTER OFFSET
    },
};
...
/* asm: 	 */
VEHTAB VEHICLE_TABLE[] = {
    { ROM_PTR(cvette_ROM), cvette_p, &VETTTAB, 0, 0, 1, C3X_INIT(1.0f, 0x0000000000ull), SPCARPASS, 0, &CVETTEPAL, 0 },
    { ROM_PTR(hotrod_ROM), hotrod_p, &HOTRODTAB, ROM_PTR(dhotrod_ROM), ROM_PTR(d2hotrod_ROM), 0, C3X_INIT(1.0f, 0x0000000000ull), SPCARPASS, 0, &HOTRODPAL, 0 },
    { ROM_PTR(missle_ROM), missle_p, &MISSILE_TAB, 0, 0, 1, C3X_INIT(1.0f, 0x0000000000ull), FCARPASS, 0, &BULLETPAL, 0 },
    { ROM_PTR(testor_ROM), testor_p, &TESTORTAB, ROM_PTR(dtestor_ROM), ROM_PTR(d2testor_ROM), 3, C3X_INIT(1.0f, 0x0000000000ull), SPCARPASS, 0, &TESTORPAL, 0 },
    { ROM_PTR(gtruck_ROM), gtruck_p, NULL, ROM_PTR(dgtruck_ROM), ROM_PTR(d2gtruck_ROM), 0, C3X_INIT(1.5f, 0x0040000000ull), TRUCKPASS, 0, &GTRUCKPAL, &DDYNA_GTRUCK },
    { ROM_PTR(ftruck_ROM), ftruck_p, NULL, 0, 0, 0, C3X_INIT(2.0f, 0x0100000000ull), TRUCKPASS, 0, &NOPAL, &DDYNA_FTRUCK },
    { ROM_PTR(cbus_ROM), cbus_p, NULL, ROM_PTR(dcbus_ROM), ROM_PTR(d2cbus_ROM), 0, C3X_INIT(2.0f, 0x0100000000ull), TRUCKPASS, 0, &NOPAL, &DDYNA_CBUS },
    { ROM_PTR(copcar_ROM), copcar_p, NULL, ROM_PTR(dcopcar_ROM), ROM_PTR(d2copcar_ROM), 2, C3X_INIT(1.0f, 0x0000000000ull), SPCARPASS, 0, &NOPAL, &DDYNA_COPCAR },
    { ROM_PTR(muscle_ROM), muscle_p, NULL, ROM_PTR(dmuscle_ROM), ROM_PTR(d2muscle_ROM), 0, C3X_INIT(1.0f, 0x0000000000ull), SPCARPASS, 0, &MUSCLEPAL, &DDYNA_MUSCLE },
    { ROM_PTR(caravan_ROM), caravan_p, NULL, ROM_PTR(dcaravan_ROM), ROM_PTR(d2carava_ROM), 0, C3X_INIT(1.2f, 0x0019999999ull), TRUCKPASS, 0, &CARAVANPAL, &DDYNA_CARAVAN },
    { ROM_PTR(sbus_ROM), sbus_p, NULL, ROM_PTR(dsbus_ROM), ROM_PTR(d2sbus_ROM), 0, C3X_INIT(2.0f, 0x0100000000ull), TRUCKPASS, 0, &NOPAL, &DDYNA_SBUS },
    { ROM_PTR(ptruckg_ROM), ptruckg_p, NULL, ROM_PTR(dptruckg_ROM), ROM_PTR(d2ptruck_ROM), 0, C3X_INIT(1.0f, 0x0000000000ull), TRUCKPASS, 0, &PTRUCKGPAL, &DDYNA_PTRUCKG },
    { ROM_PTR(mustang_ROM), mustang_ROM, NULL, ROM_PTR(dmustang_ROM), ROM_PTR(d2mustang_ROM), 0, C3X_INIT(1.0f, 0x0000000000ull), SPCARPASS, 0, &NOPAL, &DDYNA_MUSTANG },
    { ROM_PTR(toxic_ROM), 0, NULL, 0, 0, 0, C3X_INIT(2.0f, 0x0100000000ull), 0, 0, &NOPAL, 0 },
    { ROM_PTR(jeep_ROM), jeep_p, &JEEPTAB, ROM_PTR(djeep_ROM), 0, 0, C3X_INIT(1.0f, 0x0000000000ull), SMCARPASS, 0, &JEEPPAL, 0 },
    { ROM_PTR(copcarp_ROM), copcar_p, &COPCARTAB, ROM_PTR(dcopcar_ROM), ROM_PTR(d2copcar_ROM), 2, C3X_INIT(1.0f, 0x0000000000ull), SPCARPASS, 0, &NOPAL, 0 },
    { ROM_PTR(gtruckp_ROM), gtruck_p, &GTRUCKTABP, ROM_PTR(dgtruck_ROM), ROM_PTR(d2gtruck_ROM), 0, C3X_INIT(1.5f, 0x0040000000ull), TRUCKPASS, 0, &GTRUCKPAL, 0 },
    { ROM_PTR(sbusp_ROM), sbus_p, &PSBUSTAB, 0, 0, 0, C3X_INIT(5.5f, 0x0230000000ull), TRUCKPASS, 0, &NOPAL, 0 },
};
