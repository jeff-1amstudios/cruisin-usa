...
void WAVE(int wave_index) {
    ...
    _CAMERARAD.X = C3X_STF(C3X_REG(C3X_FROM_INT(0)));
    _CAMERARAD.Y = C3X_STF(C3X_REG(C3X_FROM_INT(0)));
    _CAMERARAD.Z = C3X_STF(C3X_REG(C3X_FROM_INT(0)));
    _CAMERAPOS.X = C3X_STF(C3X_REG(C3X_FROM_INT(0)));
    _CAMERAPOS.Y = C3X_STF(C3X_REG(C3X_FROM_INT(0)));
    _CAMERAPOS.Z = C3X_STF(C3X_REG(C3X_FROM_INT(0)));
    _LIGHT.Z = C3X_STF(C3X_REG(C3X_FROM_INT(0)));
    _LIGHT.X = C3X_STF(C3X_REG(C3X_IMM_F32(0.707f)));
    _LIGHT.Y = C3X_STF(C3X_REG(C3X_IMM_F32(0.707f)));
