...
extern int RACE_STARTING_POINTS[14];
...
// asm:  .globl TIMED_OUT
void TIMED_OUT(void);
// asm:  .globl BONUS_WAVE
// asm:  .globl BONUS_TABLEI
// asm:  .globl BONUS_NUMBER
...
extern int LEG_NAMES[15];

// challeng.asm
// asm:  .globl CHECK_CHALLENGER
// asm:  .globl AWAITING_CHALLENGER
// asm:  .globl ISSUED_CHALLENGE
// asm:  .globl CHALLENGE_ACCEPTED
...
// comm.asm
// asm:  .globl NOLINK
// asm:  .globl NOLINK_COUNT
// asm:  .globl POWERUP_MODE
...
// asm:  .globl BUFSTATS
// asm:  .globl RDYSBUFF_LEN
// asm:  .globl RDYBUFF_PTR
// asm:  .globl FILLBUFF_LEN
// asm:  .globl FILLBUFF_PTR
...
// asm:  .globl HEAD2HEAD_ON
// asm:  .globl CHECKPOINTS_HIT
// asm:  .globl CHECKPOINTS_RECEIVED
...
extern float TABING[6];
// asm:  .globl FIND_PLAYERS_POSITION
...
// asm:  .globl _LIGHT
// asm:  .globl _CAMERAPOS,_CAMERAVEL,_CAMERARAD,_CAMERAMATRIX
// asm:  .globl CAMERAPOSI,CAMERARADI,CAMERAMATRIXI
// asm:  .globl BLOWLIST,TMPMAT,ROTATION_MATRIX
// asm:  .globl POSTERMATI
// asm:  .globl TRANSVECTOR
// asm:  .globl DRIVE_LISTI,CAR_LISTI,SIGN_LISTI,GROUND_LISTI
// asm:  .globl DECOMP_LINE_BUFFER
...
extern int _ADDRL;
extern int _ACNTL;
// asm:  .globl _MATRIXA,_MATRIXB,_MATRIXC,_VECTORA,_VECTORB,_VECTORC,_VECTORD
...
// asm:  .globl STR23DF
// asm:  .globl STR2FORMOFFSET
// asm:  .globl STR2FORM
// asm:  .globl TOFORM,COLORFORM,INSFORM,PULFORM,PULINS
// asm:  .globl MKHSTDFORM
// asm:  .globl UPDTFORM
// asm:  .globl DISPLAY_TABLE
...
// asm:  .globl JOININGAME
// asm:  .globl _debug,_start
void _debug(void);
void _start(void);
// asm:  .globl LOGO,GETTILE_BACKGRND
...
// asm:  .globl GETTILE_BACKGRND
// asm:  .globl RATING_TAG
...
// asm:  .globl GALIL_NOTPRESENT
// asm:  .globl POWERUP_INITIALIZE_GALIL
// asm:  .globl MOTION_TESTX,MOTION_TESTY,MOTION_TESTZ
// asm:  .globl MOTION_BURNIN
// asm:  .globl RESET_GALIL
void RESET_GALIL(void);
// asm:  .globl MOTION_DLPROG

// objects.asm
// asm:  .globl _PALLIST,_PALROM
// asm:  .globl TYCO_TRKI
...
extern int EPALR;
extern int EPALL;
extern int EPALRR[129];
extern int EPALRL[129];
...
extern int VEHICLE_TABLE[198];
// asm:  .globl tower_bgrey
extern int tower_bgrey[129];
