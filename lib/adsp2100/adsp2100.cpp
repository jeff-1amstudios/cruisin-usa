...
void adsp2105_set_rx_callback(RX_CALLBACK cb) { sport_rx_callback = cb; }
void adsp2105_set_tx_callback(TX_CALLBACK cb) { sport_tx_callback = cb; }
void adsp2105_set_irq_line(int irqline, int state)
{
	if (state != 0 && adsp2100.irq_state[irqline] == 0)
